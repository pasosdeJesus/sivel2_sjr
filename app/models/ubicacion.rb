...
class Ubicacion < ActiveRecord::Base
	has_many :expulsion, class_name: "Desplazamiento", foreign_key: "id_expulsion", validate: true, dependent: :destroy
	has_many :llegada, class_name: "Desplazamiento", foreign_key: "id_llegada", validate: true, dependent: :destroy
