...
CREATE VIEW public.cben1 AS
 SELECT caso.id AS id_caso,
  ...
  WHERE ((caso.id = victima.caso_id) AND (caso.id = casosjr.caso_id) AND (caso.id = victima.caso_id));
...
CREATE VIEW public.cben2 AS
 SELECT cben1.id_caso,
   ...
   FROM (((((public.cben1
     ...
     LEFT JOIN public.msip_ubicacion ubicacion ON ((ultimodesplazamiento.id_expulsion = ubicacion.id)))
...
CREATE VIEW public.cres1 AS
 SELECT caso.id AS id_caso,
    ...
    casosjr.oficina_id,
    aslegal_respuesta.aslegal_id AS id_aslegal
   FROM public.sivel2_gen_caso caso,
    public.sivel2_sjr_casosjr casosjr,
    public.sivel2_sjr_respuesta respuesta,
    public.sivel2_sjr_aslegal_respuesta aslegal_respuesta
  WHERE ((caso.id = casosjr.caso_id) AND (caso.id = respuesta.caso_id) AND (respuesta.id = aslegal_respuesta.respuesta_id));
...
CREATE VIEW public.sivel2_gen_conscaso1 AS
 SELECT casosjr.caso_id,
   ...
   FROM ((((public.sivel2_sjr_casosjr casosjr
     ...
     LEFT JOIN public.sivel2_sjr_statusmigratorio statusmigratorio ON ((statusmigratorio.id = casosjr.estatusmigratorio_id)));
...
ALTER TABLE ONLY public.sivel2_sjr_casosjr
    ADD CONSTRAINT casosjr_id_idioma_fkey FOREIGN KEY (idioma_id) REFERENCES public.sivel2_sjr_idioma(id);
...
ALTER TABLE ONLY public.sivel2_gen_anexo_victima
    ADD CONSTRAINT fk_rails_003eee651b FOREIGN KEY (anexo_id) REFERENCES public.msip_anexo(id);
...
ALTER TABLE ONLY public.sivel2_gen_anexo_victima
    ADD CONSTRAINT fk_rails_01da62195c FOREIGN KEY (victima_id) REFERENCES public.sivel2_gen_victima(id);
